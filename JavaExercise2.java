...
public class JavaExercise2 {
    public static void main(String[] args) {
        ...
        } else if (/* 填條件：a 係 0 到 8 之間（包括0和8） */a>=0&&a<9) {
            System.out.println("a is between 0 and 8");
        } else if (/* 填條件：a 大過 9 */a>9) {
        ...
        if (/* 填條件：str 長度等於 27 */str.length()==27) {
            System.out.println("str length = 27");
        } else if (/* 填條件：str 長度細過 27 */str.length()<27) {
            System.out.println("str length < 27");
        } else if (/* 填條件：str 長度大過 27 */str.length()>27) {
            System.out.println("str length > 27");
        }
